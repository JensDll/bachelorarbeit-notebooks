...
wget -O models/mobilenet_benchmark.py "https://raw.githubusercontent.com/JensDll/bachelorarbeit-notebooks/$1/first-nn/benchmark/mobilenet_benchmark.py" && \
wget -O models/sine_benchmark.py "https://raw.githubusercontent.com/JensDll/bachelorarbeit-notebooks/$1/first-nn/benchmark/sine_benchmark.py" && \
